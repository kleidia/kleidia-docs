...
|---------|-------------|----------|
| **kleidia-agent-\<version\>.msi** | MSI for enterprise deployment (GPO, SCCM, Intune) | [GitHub Releases](https://github.com/kleidia/kleidia-docs/releases) |
| **yubikey-manager.msi** | YubiKey Manager dependency | [GitHub Releases](https://github.com/kleidia/kleidia-docs/releases) |

> [!NOTE]
> Always download installers from the official [Kleidia GitHub Releases](https://github.com/kleidia/kleidia-docs/releases) page. For enterprise deployments, use the MSI packages with your management tools (GPO, Intune, SCCM).

---

## Overview

This guide covers deploying Kleidia Agent across enterprise environments using central management tools. The agent is distributed as MSI packages for enterprise deployment.
...
- **Documentation**: https://docs.kleidia.io
- **Issues**: https://github.com/kleidia/kleidia-docs/issues
