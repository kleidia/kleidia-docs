...
|---|---|---|
| Platform | `oci://registry-1.docker.io/therinn/kleidia-platform` | `2.2.4` |
| Data | `oci://registry-1.docker.io/therinn/kleidia-data` | `2.2.4` |
| Services | `oci://registry-1.docker.io/therinn/kleidia-services` | `2.2.4` |
...
helm install kleidia-platform oci://registry-1.docker.io/therinn/kleidia-platform --version 2.2.4 \
...
helm install kleidia-data oci://registry-1.docker.io/therinn/kleidia-data --version 2.2.4 \
  --namespace kleidia \
  --set global.domain=$DOMAIN --set global.namespace=kleidia \
  --set storage.className=$SC
...
helm install kleidia-services oci://registry-1.docker.io/therinn/kleidia-services --version 2.2.4 \
  --namespace kleidia \
  --set global.domain=$DOMAIN --set global.namespace=kleidia \
